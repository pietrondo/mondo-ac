...
const BIOME_VARIANT_WEIGHTS: Record<BiomeType, { variant: MonsterVariant; weight: number }[]> = {
  [BiomeType.COAST]: [
    { variant: 'crawler', weight: 0.4 },
    { variant: 'drone', weight: 0.3 },
    { variant: 'scout', weight: 0.3 },
  ],
  [BiomeType.PLAINS]: [
    { variant: 'scout', weight: 0.4 },
    { variant: 'stalker', weight: 0.3 },
    { variant: 'drone', weight: 0.2 },
    { variant: 'brute', weight: 0.1 },
  ],
  [BiomeType.FOREST]: [
    { variant: 'stalker', weight: 0.4 },
    { variant: 'crawler', weight: 0.3 },
    { variant: 'scout', weight: 0.2 },
    { variant: 'brute', weight: 0.1 },
  ],
  [BiomeType.DESERT]: [
    { variant: 'golem', weight: 0.3 },
    { variant: 'brute', weight: 0.3 },
    { variant: 'stalker', weight: 0.2 },
    { variant: 'sentinel', weight: 0.2 },
  ],
  [BiomeType.MOUNTAIN]: [
    { variant: 'golem', weight: 0.4 },
    { variant: 'brute', weight: 0.3 },
    { variant: 'sentinel', weight: 0.2 },
    { variant: 'annihilator', weight: 0.1 },
  ],
  [BiomeType.SNOW]: [
    { variant: 'golem', weight: 0.3 },
    { variant: 'sentinel', weight: 0.3 },
    { variant: 'annihilator', weight: 0.2 },

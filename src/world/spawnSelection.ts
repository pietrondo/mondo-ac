...
const BIOME_VARIANT_WEIGHTS: Record<BiomeType, { variant: MonsterVariant; weight: number }[]> = {
  ...
  [BiomeType.PLAINS]: [
    { variant: 'scout', weight: 0.35 },
    { variant: 'stalker', weight: 0.25 },
    { variant: 'phantom', weight: 0.2 },
    { variant: 'drone', weight: 0.1 },
    { variant: 'brute', weight: 0.1 },
  ],
  [BiomeType.FOREST]: [
    { variant: 'stalker', weight: 0.35 },
    { variant: 'phantom', weight: 0.25 },
    { variant: 'crawler', weight: 0.2 },
    { variant: 'scout', weight: 0.1 },
    { variant: 'brute', weight: 0.1 },
  ],
  [BiomeType.DESERT]: [
  ...
  [BiomeType.MOUNTAIN]: [
    { variant: 'titan', weight: 0.3 },
    { variant: 'golem', weight: 0.3 },
    { variant: 'brute', weight: 0.2 },
    { variant: 'sentinel', weight: 0.1 },
